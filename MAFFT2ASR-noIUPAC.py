class MAFFTTOASR():
	...
	def ALIGNCONV(self, inputfilename,inputformat,outputfilename):
		...
		outputformat = "nexus"
		handle = StringIO()
		AlignIO.convert(inputfilename,inputformat,handle,outputformat,"protein")
		#try:
		#	align = AlignIO.read(open(inputfilename,"rU"),inputformat,alphabet = IUPAC.extended_protein)
		#except:
		#align = AlignIO.read(open(inputfilename,"r"),inputformat,"protein")
		#print(align)
		merged_data = ''.join(handle.getvalue().split("\t"))
		print(merged_data)
	...
	def CODEMLGENERATOR(self,outputfilename,outputphylo):
		...
		aaDist = 0\n\
		aaRatefile = /home/test/Downloads/paml4.9j/dat/jones.dat \n\
	...
	def ALIGNCONV_MAFFT2PAML(self,inputfilename,inputformat,outputfilename):
		...
		#	align = AlignIO.read(open(inputfilename,"rU"),inputformat,alphabet = IUPAC.extended_protein)
		#except:
		align = AlignIO.read(open(inputfilename,"rU"),inputformat)
